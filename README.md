...
This repository contains a parental control software for MuOS. Some minor modifications were added to the original version at 
`https://github.com/X-Ryl669/parentlock` to make the application compatible with _goose_ releases of MuOS. 
This application is made to set up and limit device usage time.
The configuration and usage are described below.

## Installation
Copy `parentlock.muxzip` to `/mnt/mmc/ARCHIVE` folder on your SD and open the file in _Archive Manager_. 
